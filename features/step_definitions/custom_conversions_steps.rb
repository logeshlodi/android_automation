...
Then(/^I type "([^"]*)" as unit value$/) do |unit_values|
  find_element(id: "edit_custom_conversion_unit_dtls_value").send_keys(unit_values)
end
...
Then(/^I press OK button on Custom conversions screen$/) do
